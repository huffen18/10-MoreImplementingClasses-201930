    ...
    *** See the PDFs, especially dimensions.pdf, to help you understand this.
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        *** See   dimensions.pdf   to understand the following! ***
        ...
        h_rect = rg.Rectangle
        v_rect = rg.Rectangle
        h_rect.get_center(intersection_center)
        self.h_rect = h_rect
        self.v_rect = v_rect
    ...
    def clone(self):
        ...
        #######################################################################
        rg.Rectangle(self.h_rect.get_upper_left_corner(), self.h_rect.get_lower_right_corner())
        rg.Rectangle(self.v_rect.get_upper_left_corner(), self.v_rect.get_lower_right_corner())
